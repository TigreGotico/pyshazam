...
Every API client in this organisation is also a dataset construction pipeline. This document describes what `shazampy` can produce, what is safe and useful to publish, and the downstream ML tasks the data serves.
